...
def main(argv):
    ...
    if not os.path.exists(os.path.join(args.output_directory, "dataset_stats.txt")):
    ...
    # This will then be used to properly align rooms.
        ...
        print("Loading training statistics for dataset with bounds: {} from {}".format(
                train_dataset.bounds, path_to_json))
        with open(path_to_json, "r") as f:
            train_dataset_stats = json.load(f)
